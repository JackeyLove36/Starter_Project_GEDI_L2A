...
namespace WPM {
    ...
    _map.labelsAntialias
            ...
            if (expandGridSection) {
                ...
                _map.gridLinesColor = WPMEditorStyles.HDRColorPicker("Lat/Lon Lines Color", _map.gridLinesColor);
                _map.showTropicLines = EditorGUILayout.Toggle("Show Tropic Lines", _map.showTropicLines);
                _map.tropicLinesColor = WPMEditorStyles.HDRColorPicker("Tropic Lines Color", _map.tropicLinesColor);
            ...
            if (expandCountriesSection) {
                ...
                if (_map.enableCountryHighlight) {
                    ...
                    _map.enableContinentHighlight = EditorGUILayout.Toggle("Include Continent", _map.enableContinentHighlight);
            ...
            if (expandCitiesSection) {
                ...
                if (_map.showCities && _map.cities != null) {
                    ...
                    _map.enableCityHighlight = EditorGUILayout.Toggle("Enable Highlight", _map.enableCityHighlight);
                    if (_map.enableCityHighlight) {
                        EditorGUI.indentLevel++;
                        _map.citiesHighlightColor = EditorGUILayout.ColorField("Color", _map.citiesHighlightColor);
                        EditorGUI.indentLevel--;
                    }
            ...
            if (expandCameraControlSection) {
                ...
                if (_map.enableOrbit) {
                    EditorGUI.indentLevel++;
                    _map.pitch = EditorGUILayout.Slider("Pitch", _map.pitch, -_map.maxPitch, _map.maxPitch);
