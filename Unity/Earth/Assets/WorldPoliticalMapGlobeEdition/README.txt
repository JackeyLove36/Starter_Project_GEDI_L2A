...
Version 17.2.2
  - [Fix] Updated Google Satellite url with no labels link

Version 17.2.1
  - Added "Include Continent" option to Country Highlight section
  - Added "Fade" parameter to country/province highlight section
  - Online tiles: added 3 new servers for MapTiler 

Version 17.1.1
  - Added demo scene 16 "Globe At Top Screen"
  - [Fix] API: fixed calculation bug in one of the GetLatLonFromSpherePoint overloads

Version 17.0
  - Line drawing: added "useTube" parameter which uses a 3D tube instead of a flat 2D line
  - Added tropic lines (toggle them on/off from the Grid section in the inspector)

Version 16.6
  - Allowed negative pitch in Orbit feature
  - Change: city combine meshes option has been replaced with GPU instancing shaders
  - [Fix] Fixed OnCityEnter event triggered twice

Version 16.5.4
  - [Fix] Fixed issue transferring a country to a new country without regions

Version 16.5.3
  - Updated compatibility with Oculus Integration Plugin
  - [Fix] Fixed country highlighting failing over enclaves

Version 16.5.1
  - Minimum Unity version required is now 2020.3.16
  - [Fix] Fixed regression issue which caused frontiers not rendering properly in a build

Version 16.5
  - Added city highlight effect
  - Map Editor: added ability to select multiple provinces holding Control key (+ merge/new country creation commands)
